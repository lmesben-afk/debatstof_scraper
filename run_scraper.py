...
JP_VALUE_KEYWORDS = {
    ...
    "land_og_by": [
        "landdistrikter", "udkantsdanmark", "landsbyerne", "landsby", "provinsen",
        "centralisering", "affolkning", "udkanten", "lokalbane", "lokalbaner",
        "togstation", "buslinje", "sygehus lukker", "skole lukker", "gymnasium lukker",
        "motorvej", "rural", "tyndt befolket",
    ],
    "manglende_myndighedsansvar": [
        "ignorerede",
        "intet svar fra",
        "fik ikke hjælp",
        "systemet svigtede",
...
MICRO_TOPIC_PATTERNS = {
    # --- Frit valg / privatisering (splittet fra frit_valg_på_plejehjem) ---
    "frit_valg_og_privatisering": [
        "frit valg",
        "valgfrihed",
        "privat leverandør",
    ...
    # --- Ældrepleje (renset for overlap med frit_valg) ---
    ...
    # --- Psykiatri (splittet fra psykiatri_og_unge) ---
    "psykiatri_og_mental_sundhed": [
        "psykiatri",
        "psykisk sygdom",
        "psykisk lidelse",
        "angst",
    ...
    # --- Unges trivsel og skærme (sammenlægning af psykiatri_og_unge + skærme_sociale_medier_og_børn) ---
    "unges_trivsel_og_skærme": [
        "børn og unge",
        "unges trivsel",
        "unges mistrivsel",
    ...
    "udenlandsk_indflydelse_og_propaganda": [
        "propaganda",
        "desinformation",
        "informationskrig",
    ...
    "sundhedsvæsen_og_patientrettigheder": [
        "sundhedsvæsenet",
        "patientrettigheder",
        "patientsikkerhed",
        "lægefejl",
